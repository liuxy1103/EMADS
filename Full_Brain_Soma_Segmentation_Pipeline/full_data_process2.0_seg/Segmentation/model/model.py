...
class UNet3D(nn.Module):
    def __init__(self, in_channel=1, n_classes=3, bn=False):
        ...
        self.dc0 = self.decoder2(16, n_classes, kernel_size=1, stride=1, bias=False)
    ...
    def decoder2(self, in_channels, out_channels, kernel_size, stride=1, padding=0,
                bias=True):
        layer = nn.Sequential(
            nn.Conv3d(in_channels, out_channels, kernel_size, stride=stride,
                               padding=padding, bias=bias),
