...
parser.add_argument("-d", "--data_dir",type=str,default="/braindat/lab/liuxy/soma_seg/Patch_level_experiments/three_classes/CellSeg_v2_final")
...
parser.add_argument("-w", "--weight_rate",type=list,default=[1, 10, 100]) #0,1,2
