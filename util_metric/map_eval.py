...
def get_args_eval_mito():
    ...
    parser.add_argument('-cz', '--chunk-size', type=int, default=548,
...
def eval_mito(gt_seg, predict_seg, output_name):
    ...
    model_num = 123 # 000000 取出来
    path = './' # 提取save model 路径下的model
    ...
    if args.do_eval > 0:
        ...
        v3dEval.accumulate()
        v3dEval.summarize()
    score_all = v3dEval.stats[0] #0.5-0.95
    print('ap', score_all)
    score_50 = v3dEval.stats[1]
    print('ap50', score_50)
    score = v3dEval.stats[2]
    print('ap75', score)
    return score_all,score_50,score
